    ...
    <div class="container p tablet:pb-[74px] row flex-col gap-6 flex mx-auto">
      <header class="hidden bg-[#5D6065] tablet:flex relative justify-between items-center row w-full h-20">
        <div class="flex gap-4 items-center">
          ...
          >
          <div class="text-xl lg:font-bold text-white lg:text-3xl">New Release</div>
        </div>
      ...
      >
        <div
          ...
          :key="index"
          class="cursor-pointer overflow-hidden drop-shadow-lg rounded-3xl relative h-[240px] w-full"
        >
