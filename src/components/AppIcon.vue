<template>
  <div class="app-icon duration-300" :style="style">
    ...
    <svg v-if="name === 'home'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
      <g  stroke="none" stroke-width="1" fill="none" >
        <g transform="translate(-144.000000, -48.000000)">
          <g transform="translate(144.000000, 48.000000)">
            <path d="M13.2,2.65 C12.4889,2.11667 11.5111,2.11667 10.8,2.65 L3.8,7.9 C3.29639,8.27771 3,8.87049 3,9.5 L3,19 C3,20.1046 3.89543,21 5,21 L8.9,21 C9.50751,21 10,20.5075 10,19.9 L10,15 C10,13.8954 10.8954,13 12,13 C13.1046,13 14,13.8954 14,15 L14,19.9 C14,20.5075 14.4925,21 15.1,21 L19,21 C20.1046,21 21,20.1046 21,19 L21,9.5 C21,8.87049 20.7036,8.27771 20.2,7.9 L13.2,2.65 Z" id="路径" fill="#09244B"></path>
          </g>
        </g>
      </g>
    </svg>
    <svg v-if="name === 'compass'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="9" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
      <path d="M9.87867 9.87869L16.2426 7.75737L14.1213 14.1213L7.75735 16.2426L9.87867 9.87869Z" stroke="#000000"
            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
    </svg>
    <svg v-if="name === 'bookmark'" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg v-if="name === 'download'" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 211.293 211.293" xml:space="preserve">
<g>
